...
public class TwoPlayerGameScreen extends GameScreen {
	...
	protected Set<Player> createPlayersOnLevelSetUp(GameMap map) {
		...
		players.add(new HumanPlayer(map.getEndCell(), map.getStartCell(), playerBaseVel, GameConstants.PLAYER_TOLERANCE_CONSTANT,
				GameConstants.PLAYER2_COLOR, GameConstants.PLAYER2_DEFAULT_NAME, GameConstants.PLAYER_PROPORTION_OF_CELL_DIMENSIONS,numCheckpoints,
